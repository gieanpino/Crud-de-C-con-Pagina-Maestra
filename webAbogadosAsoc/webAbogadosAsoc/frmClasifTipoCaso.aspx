<%@ Page Title="" Language="C#" MasterPageFile="~/frmPrincipal.Master" AutoEventWireup="true" CodeBehind="frmClasifTipoCaso.aspx.cs" Inherits="webAbogadosAsoc.Formulario_web14" %>
<asp:Content ID="Content4" ContentPlaceHolderID="Cuerpo" runat="server">
    <table align="center" class="auto-style3">
        <tr>
            <td class="auto-style4"><strong>Maestro de Clasificación de los Tipos de Casos</strong></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
